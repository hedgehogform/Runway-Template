...
void UWebCommunicationBPLibrary::httpRequestCompleteDelegate(const TArray<FString>& Data, const TArray<FString>& Header, const int32 statusCode, const TArray<uint8>& byteData, const FString& requestID) {
}
