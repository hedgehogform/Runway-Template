...
public:
    ...
    DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FhttpRequestCompleteDelegate, const TArray<FString>&, Data, const TArray<FString>&, Header, const int32, statusCode, const TArray<uint8>&, byteData, const FString&, requestID);
    ...
    UFUNCTION(BlueprintCallable)
    void httpRequestCompleteDelegate(const TArray<FString>& Data, const TArray<FString>& Header, const int32 statusCode, const TArray<uint8>& byteData, const FString& requestID);
